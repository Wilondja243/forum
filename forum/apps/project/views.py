...
from forum.apps.project.forms import (LoginForm, ProfilForm, 
        QuestionForm, SearchQuestionForm, UserForm)
from forum.apps.project.models import ProfilModel, QuestionModel

# sing in form validation
class SinginView(View):
    model = User
    form_class = UserForm
    template_name = 'templates/singin.html'
...
class ImageProfilMakerView(LoginRequiredMixin, FormView):
    ...
    template_name = 'templates/image_profil_maker.html'
    success_url = reverse_lazy('home')
...
class ProfilView(DetailView):
    model = ProfilModel
    template_name = 'templates/profil.html'
...
class PublishQuestionView(View):
    ...
    template_name = 'templates/publish_question.html'
    success_url = reverse_lazy('home')
